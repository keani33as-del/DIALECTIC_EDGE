...
def synth_overlay(pack: HorizonPack) -> str:
    ...
    return (
        ...
        "═ КАЛИБРОВКА (апрель 2026, 25 наблюдений) ═\n"
        "BULL вердикты сработали в 50% случаев, BEAR в 14% (статистически хуже монетки),\n"
        "NEUTRAL в 33%. Перед выдачей BEAR — спроси «есть ли 2+ конкретных риска с цифрами\n"
