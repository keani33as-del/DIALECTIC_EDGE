...
4. Если FinBERT MIXED но данные показывают конкретные движения (например SOL +3%+) → укажи уклон

Если MIXED + данные разнонаправленные → выбирай наиболее сильный %:
- "НЕЙТРАЛЬНЫЙ (с уклоном в бычий)" — если Bull-показатели перевешивают
- "НЕЙТРАЛЬНЫЙ (с уклоном в медвежий)" — если Bear-показатели перевешивают
